...
if not isfile("Drunkbed.JSON") then writefile("Drunkbed.JSON","Drunkbed made by Nukekia_SPDM , NTD , Creator , Nightbed Team , Drunkbed Team")
end
makefolder("Drunkbed")
game.StarterGui:SetCore("SendNotification", {
	Title = "Drunkbed Loading";
	Text = "Loading... Data Script"; -- what the text says (ofc)
	Duration = 60;
})
wait(1)
game.StarterGui:SetCore("SendNotification", {
	Title = "Loading";
	Text = "Loading... please wait"; -- what the text says (ofc)
	Duration = 60;
})
wait(5)
game.StarterGui:SetCore("SendNotification", {
	Title = "Drunkbed Script";
	Text = "Prees Quote to Open And Close GUI"; -- what the text says (ofc)
	Duration = 60;
})
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Drunkbed Hub", "Ocean")
local Tab = Window:NewTab("Update")
local Section = Tab:NewSection("Nightbed X Drunked Bed")
local Section = Tab:NewSection("Nightbed X Drunked Bed")
local Section = Tab:NewSection("Nightbed X Drunked Bed")
local Section = Tab:NewSection("Nightbed X Drunked Bed")
local Section = Tab:NewSection("Nightbed X Drunked Bed")
...
Section:NewButton("ESP (Work!)", "eee", function()
...
Section:NewButton("INF JUMP (Work!)", "eee", function()
...
local Taunts = { --add as many as you wish
  "get better 1 fps loser",
  "bad gaming chair go cry😂",
  "Skill issues? use DrunkBed",
  "My Hacks were 10Bil Robux and money loser cry 😂",
...
local Taunts = { --add as many as you wish
  "What a loser you are DrunkBed Is too powerful HEHEHEA",
  "I dont care if im hacking im not nu b like you",
  "Skill issues? use Drunk Bed V1",
  "YOU CANT FIND ME LOL YOUR USING 1 DOLLAR PHONE OR COMPUTER",
  "FIND ME NOOB SO TRASH SEEKER", 
...
Section:NewButton("Nightbed", "By NTD", function()
    game.StarterGui:SetCore("SendNotification", {
	Title = "Bedwars Hub V2.1b Script";
	Text = "Prees Quote to Open And Close GUI"; -- what the text says (ofc)
	Duration = 60;
})
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("NightBed Hub V2.0.1b", "DarkTheme")
local Tab = Window:NewTab("Main")
local Section = Tab:NewSection("Script (Not work ) ")
Section:NewKeybind("KillAura", "KeybindInfo", Enum.KeyCode.K, function()
...
Section:NewButton("Owner Script", "DB", function()
    print("By DB")
end)
Section:NewButton("Softbed Script", "YZHacker", function()
    print("By YZHacker")
...
Section:NewButton("Script", "NTD", function()
    print("By NTD")
end)
local Tab = Window:NewTab("Setting")
local Section = Tab:NewSection("Setting")
